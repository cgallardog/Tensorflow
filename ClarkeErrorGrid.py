...
def clarke_error_grid(ref_values, pred_values, title_string):
    ...
    # Set up plot
    plt.scatter(ref_values, pred_values, marker='o', color='red', s=1)
...
def main():
    ...
    for i in range(len(all_models)):
        ...
        file_dir_path = 'OptimizacionParametros/GLU_HR/' + model_file + '/' + model_file
        save_path = 'OptimizacionParametros/GLU_HR/' + model_file + '/clarke_error_percentages.xlsx'
        first = True
        for p in test_data:
