...
for i in range(len(all_models)):
    ...
    model_path = 'OptimizacionParametros/4_feat/' + model_file + '/' + model_file + '.tf'
    '''
    if extrapolate == 1:
...
all_metrics.to_excel(dir_models + '/mejores_metricas_4_feat.xlsx', header=True, index=False)
